...
;General
  ...
  ;Name and file
  Name "Pomodoro"
  !define EXE_NAME "pomodoro.exe"
  OutFile "install_pomodoro.exe"
  Unicode True
...
;Pages
  ...
  !insertmacro MUI_PAGE_LICENSE "installation_license.txt"
...
Section "Main Section" SecMain
  ...
  File /r "dist\pomodoro\*.*" ; a copy command, here we are recursively copying all files of dist\pomodoro to the installation directory
